...
[`@aws-sdk/client-arc-region-switch`](https://www.npmjs.com/package/@aws-sdk/client-arc-region-switch/v/3.899.0).
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-region-switch@3.899.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-MOhJ2Wq61LDeHuA33X3IO1A+MEK2OmAS1yBzQU9/860xmXFni9MlKQ0L0aChMFt6
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-arc-region-switch": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-region-switch@3.899.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-arc-region-switch@3.899.0/index.min.mjs": "sha384-MOhJ2Wq61LDeHuA33X3IO1A+MEK2OmAS1yBzQU9/860xmXFni9MlKQ0L0aChMFt6"
        }
      }
</script>
```
...
```
https://github.com/cloud-sdk-builds/client-arc-region-switch/blob/refs/tags/3.899.0/LICENSE
```
